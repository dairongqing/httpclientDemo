...
package com.pengtu.service.gps;
 ...
 */
@Service
public class VehMonitorService extends DefaultBaseController{
	/**
	 * 保持登陆有效
	 * @return
	 * @throws Exception
...
//		"011"班车客运  012" 包车客运 "020" 货运 "030" 危险品 "050:驾培 "080"公交 090出租 "900" 其他
	...
	public static void main(String[] args) {
		String url = "https://ep.meeb.sz.gov.cn/sdata/v1/rest/dataShare/consume/dataShareApi/9fbbafb6-b85d-408f-a4f4-92880afac57b";
		String key = "F8C98E15-25B9-4A7C-8660-83FE7CB49D28";
		
		Map<String,String> bodyMap = new HashMap<>();
		bodyMap.put("key", key);
		String result = HttpClientUtil.sendSSLPost2(url, null, bodyMap);
